...
Кварцевые инструменты функционально идентичны железным инструментам, имеют такой же урон, прочность, скорость добычи и другие параметры. Существуют варианты из кварца Нижнего мира и [истинного кварца](fluix_crystal.md).
