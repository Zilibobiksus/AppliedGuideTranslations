...
navigation:
  ...
  title: Декоративные блоки из истинного кварца
  icon: quartz_stairs
  position: 010
categories:
...
# Декоративные блоки из истинного кварца
...
<ItemLink id="quartz_block" /> можно создавать, плавить и обрабатывать на камнерезе в некоторые декоративные строительные блоки
