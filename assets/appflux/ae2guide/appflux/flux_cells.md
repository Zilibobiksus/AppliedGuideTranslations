...
Ячейки хранения FE — основной способ хранения энергии в Applied Flux. Их ёмкость основана на байтах, как и [ячейки хранения предметов/жидкостей](ae2:items-blocks-machines/storage_cells.md).

# Ёмкость ячеек

По умолчанию каждый байт может содержать 1 048 576 FE, что можно изменить в конфигурации Appflux.

| Ячейка                                 | Ёмкость ячейки в FE (по умолчанию) |
|----------------------------------------|------------------------------------:|
